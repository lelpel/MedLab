...
public class EditEquipmentDialog extends DialogFragment {
    interface OnDialogInteractionListener {
        void onPositive(EditEquipmentDialog dialog, long editId);
        void onNegative(EditEquipmentDialog dialog);
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage(R.string.add_eq).setView(view).setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                listener.onPositive(EditEquipmentDialog.this, getArguments().getLong("EDITID"));
            }
        }).setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                listener.onNegative(EditEquipmentDialog.this);
            }
        });
    ...
    public static EditEquipmentDialog newInstance(long id) {
        Bundle b = new Bundle();
        b.putLong("EDITID", id);
        EditEquipmentDialog instance = new EditEquipmentDialog();
